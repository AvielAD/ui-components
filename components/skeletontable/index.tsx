  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="h-4 bg-secondary-200 rounded col-span-1"></div>
        <div className="h-4 bg-secondary-200 rounded col-span-3"></div>
      ...
      <div className="mt-4 grid grid-cols-4 gap-4">
        <div className="h-8 bg-secondary-200 rounded col-span-1"></div>
        <div className="h-8 bg-secondary-200 rounded col-span-3"></div>
        <div className="h-8 bg-secondary-200 rounded col-span-2"></div>
        <div className="h-8 bg-secondary-200 rounded col-span-2"></div>
        <div className="h-8 bg-secondary-200 rounded col-span-1"></div>
        <div className="h-8 bg-secondary-200 rounded col-span-3"></div>
      </div>
